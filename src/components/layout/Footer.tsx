...
export function Footer({
    ...
    return (
        <footer className="bg-white dark:bg-gray-950 text-gray-900 dark:text-white border-t border-gray-100 dark:border-gray-800">
            {/* Main Footer */}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-10 lg:gap-12">
                    ...
                    <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-12">
                        <Link href="/" className="flex items-center gap-2 mb-4">
                            ...
                            <span className="font-bold text-xl text-gray-900 dark:text-white">{logoText}</span>
                        </Link>
                        ...
                        <div className="space-y-3">
                            {contactEmail && (
                                <a
                                    ...
                                    className="flex items-center gap-3 text-sm text-gray-600 dark:text-gray-400 hover:text-primary-600 dark:hover:text-white transition-colors"
                                >
                ...
                <div className="container-main py-6">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4">
                        ...
                        <div className="flex items-center gap-6">
                            <Link
                                href="/gizlilik"
                                className="text-sm text-gray-500 hover:text-primary-600 dark:hover:text-white transition-colors"
                            >
                                Gizlilik Politikası
                            </Link>
                            <Link
